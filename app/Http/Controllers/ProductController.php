...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $query = Product::with(['media'])
                ->leftJoin('business', 'products.business_id', '=', 'business.id')
            ...
            $products = $query->select(
                ...
                'business.show_product_second_name as show_product_second_name',
            ...
            return Datatables::of($products)
                ...
                ->editColumn('product', function ($row) use ($is_woocommerce) {
                    ...
                    $product = $row->not_for_selling == 1 ? $product . ' <span class="label bg-gray">' . __("lang_v1.not_for_selling") .
                        ...
                        if ($row->show_product_second_name == 1) {
                            $product = $product . '<br>' . $row->second_name;
                        }
    ...
    public function create()
    {
        ...
        return view('product.create')
            ->with(compact('categories', 'brands', 'units', 'taxes', 'barcode_types', 'default_profit_percent', 'tax_attributes', 'barcode_default', 'business_locations', 'duplicate_product', 'sub_categories', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties', 'pos_module_data', 'business'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($business->show_product_second_name == 1){
                $form_fields = ['name',  'second_name', 'brand_id', 'unit_id', 'category_id', 'tax', 'type', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_description', 'sub_unit_ids'];
            }else{
    ...
    public function edit($id)
    {
        ...
        return view('product.edit')
                ->with(compact('categories', 'brands', 'units', 'sub_units', 'taxes', 'tax_attributes', 'barcode_types', 'product', 'sub_categories', 'default_profit_percent', 'business_locations', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties', 'pos_module_data', 'alert_quantity', 'business'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if($business->show_product_second_name == 1){
                $product_details = $request->only(['name', 'second_name', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'product_custom_field2', 'product_custom_field3', 'product_custom_field4', 'product_description', 'sub_unit_ids']);
            }else{
            ...
            if($business->show_product_second_name == 1){
                $product->second_name = $product_details['second_name'];
            }
