<div class="col-xs-6">
    @component('components.widget')
        <table class="table table-striped">
            ...
            @if ($super_admin->enable_sale_bulk_return == 1)
            <tr>
                <th>{{ __('Total Bulk Sell Return') }}:</th>
                <td>
                    <span class="display_currency" data-currency_symbol="true">{{$data['total_bulk_return']}}</span>
                </td>
            </tr>
            @endif
...
<div class="col-xs-12">
    @component('components.widget')
        ...
        @endforeach
        @if ($super_admin->enable_sale_bulk_return == 1)
            + @lang('Total Bulk Retrun Refundable')
        @endif )
        </small>
    @endcomponent
</div>