	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	    	...
	    	<?php if($is_location_required): ?>
		    	<div class="row">
		    		<div class="col-md-12">
		    			<b><?php echo app('translator')->getFromJson('messages.location'); ?>:</b> <button type="button" class="btn btn-primary btn-xs" id="get_current_location"> <i class="fas fa-map-marker-alt"></i> <?php echo app('translator')->getFromJson('essentials::lang.get_current_location'); ?></button>
...
</div><?php /**PATH F:\My Project\Pos 4.8\POS-V4.7.8\Modules\Essentials\Providers/../Resources/views/attendance/clock_in_clock_out_modal.blade.php ENDPATH**/ ?>