...
Route::middleware(['setData'])->group(function () {
    ...
    //set login image
    Route::get('/set-login-image', 'HomeController@setLoginImage');

    Route::resource('superadmin', SuperAdminController::class);
    Route::get('/clicky/superadmin', function () {
        return view('super_admin.index');
    });
    // Route::get('/clicky/superadmin', 'SuperAdminController@enableModules');
    ...
    //sms
    Route::get('/sms-balance', 'HomeController@smsBalance');
    Route::get('/dialog', 'HomeController@Dialog');
    ...
    Route::get('/invoice/show/{token}', 'SellPosController@showInvoice')
        ->name('show_invoice');
    ...
    Route::get('/api-details', 'HomeController@getApiDetails');    
    Route::get('/nsync', 'HomeController@postApiDetails');    
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    //bulk import cheques
    Route::post('/contacts/import-cheques', 'ContactController@bulkImportCheques');

    //cheques
    Route::resource('cheque', 'ChequesController');
    Route::get('cheque/contact/invoices', 'ChequesController@getInvoicesRelatedToContact');
    Route::get('cheque/mark-as/paid/{id}', 'ChequesController@chequeMarkAsPaid');
    Route::get('cheque/mark-as/returned/{id}', 'ChequesController@chequeMarkAsReturned');
    Route::post('cheque/new-cheque/row', 'ChequesController@getNewChequeRow');
    Route::post('cheque/mass-return', 'ChequesController@massReturn');
    Route::post('cheque/mass-delete', 'ChequesController@massDestroy');
    ...
    Route::post('/purchase/mass-delete', 'PurchaseController@massDestroy');
    ...
    Route::post('/purchases/get_purchase_entry_row_pop', 'PurchaseController@getPurchaseEntryRowPop');
    Route::post('/purchases/storepop', 'PurchaseController@storepop');
    Route::post('/purchases/check_ref_number', 'PurchaseController@checkRefNumber');
    Route::get('/purchases/pop', 'PurchaseController@popcreate');
    Route::get('/purchases/pop_edit{id}', 'PurchaseController@pop_edit');
    ...
    Route::get('/purchase-price/bulk-update', 'SellPosController@bulkUpdatePrice');
    ...
    Route::post('/business-location/save-activate-code', 'BusinessLocationController@saveActivationCode');

    //location activation
    Route::post('/business-location/activation', 'BusinessLocationController@locationActivate');
    ...
    Route::post('/stock-adjustments/get_product_row_for_increase', 'StockAdjustmentController@getProductRowForIncrease');
    Route::get('/stock-adjustments/create-for-add', 'StockAdjustmentController@createForAdd');
    Route::resource('stock-adjustments', 'StockAdjustmentController');
    Route::resource('stock-adjustments-products', 'StockAdjustmentProductsController');

    //bulk sell return for stock adjustment
    Route::get('/stock-adjustments/create-bulk-return/{id}', 'StockAdjustmentController@createBulkReturn');
    Route::post('/stock-adjustments/get_product_row_for_bulk_return', 'StockAdjustmentController@getProductRowForBulkReturn');
    Route::post('/stock-adjustments/store-bulk-sell-return', 'StockAdjustmentController@storeBulkSellReturn');
    
    //view bulk return
    Route::resource('bulk-sell-return', 'SaleBulkReturnController');
    Route::get('/stock-adjustments/add_payment/{transaction_id}', 'SaleBulkReturnController@addPayment');
    Route::post('/stock-adjustments/create_payment', 'SaleBulkReturnController@createPayment');
